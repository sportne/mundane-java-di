...
class GeneratedModuleRequestTest {
    ...
    void rejectsNullRecordInputs() {
        assertThrows(NullPointerException.class, () -> new GeneratedModuleRequest(
                null, "GeneratedAppModule", List.of()));
        assertThrows(NullPointerException.class, () -> new GeneratedModuleRequest(
                "com.example.generated", null, List.of()));
        assertThrows(NullPointerException.class, () -> new GeneratedModuleRequest(
                "com.example.generated", "GeneratedAppModule", null));
        assertThrows(NullPointerException.class, () -> new GeneratedModuleRequest(
                "com.example.generated", "GeneratedAppModule", listWithNull()));

        assertThrows(NullPointerException.class, () -> new GeneratedModuleRequest.ConstructorBinding(
                null, Optional.empty(), List.of()));
        assertThrows(NullPointerException.class, () -> new GeneratedModuleRequest.ConstructorBinding(
                "com.example.Service", null, List.of()));
        assertThrows(NullPointerException.class, () -> new GeneratedModuleRequest.ConstructorBinding(
                "com.example.Service", Optional.empty(), null));
        assertThrows(NullPointerException.class, () -> new GeneratedModuleRequest.ConstructorBinding(
                "com.example.Service", Optional.empty(), listWithNull()));

        assertThrows(NullPointerException.class, () -> new GeneratedModuleRequest.Dependency(
                null, Optional.empty()));
        assertThrows(NullPointerException.class, () -> new GeneratedModuleRequest.Dependency(
                "com.example.Repository", null));
    }

    @Test
    void rejectsNullFactoryInputs() {
        assertThrows(NullPointerException.class, () -> binding(null));
        assertThrows(NullPointerException.class, () -> binding(
                "com.example.Service", (GeneratedModuleRequest.Dependency[]) null));
        assertThrows(NullPointerException.class, () -> binding("com.example.Service", listWithNull()
                .toArray(GeneratedModuleRequest.Dependency[]::new)));
        ...
        assertThrows(NullPointerException.class, () -> namedBinding(
                "com.example.Service", "primary", (GeneratedModuleRequest.Dependency[]) null));
        assertThrows(NullPointerException.class, () -> namedBinding(
                "com.example.Service", "primary", listWithNull().toArray(GeneratedModuleRequest.Dependency[]::new)));
    ...
    void defensivelyCopiesBindings() {
        ...
        GeneratedModuleRequest request = new GeneratedModuleRequest(
                "com.example.generated", "GeneratedAppModule", bindings);
        bindings.clear();

        assertEquals(List.of(serviceBinding), request.bindings());
        assertThrows(UnsupportedOperationException.class, () -> request.bindings()
                .add(binding("com.example.OtherService")));
    }
    ...
    void defensivelyCopiesDependencies() {
        ...
        GeneratedModuleRequest.ConstructorBinding serviceBinding = new GeneratedModuleRequest.ConstructorBinding(
                "com.example.Service", Optional.empty(), dependencies);
        dependencies.clear();

        assertEquals(List.of(repository), serviceBinding.dependencies());
        assertThrows(UnsupportedOperationException.class, () -> serviceBinding.dependencies()
                .add(of("com.example.OtherRepository")));
    }

    @Test
    void acceptsNamedScalarPrimitiveDependencies() {
        assertEquals(named("boolean", "flag"), new GeneratedModuleRequest.Dependency("boolean", Optional.of("flag")));
        assertEquals(named("byte", "tiny"), new GeneratedModuleRequest.Dependency("byte", Optional.of("tiny")));
        assertEquals(named("char", "letter"), new GeneratedModuleRequest.Dependency("char", Optional.of("letter")));
        assertEquals(named("double", "ratio"), new GeneratedModuleRequest.Dependency("double", Optional.of("ratio")));
        assertEquals(named("float", "scale"), new GeneratedModuleRequest.Dependency("float", Optional.of("scale")));
        assertEquals(named("int", "count"), new GeneratedModuleRequest.Dependency("int", Optional.of("count")));
        assertEquals(named("long", "distance"), new GeneratedModuleRequest.Dependency("long", Optional.of("distance")));
        assertEquals(named("short", "small"), new GeneratedModuleRequest.Dependency("short", Optional.of("small")));
    }
    ...
    void rejectsInvalidModulePackageNames() {
        for (String packageName : invalidQualifiedJavaNames()) {
            assertThrows(IllegalArgumentException.class, () -> new GeneratedModuleRequest(
                    packageName, "GeneratedAppModule", List.of()), packageName);
        }
    }
    ...
    void rejectsInvalidModuleClassNames() {
        for (String className : invalidSimpleTypeNames()) {
            assertThrows(IllegalArgumentException.class, () -> new GeneratedModuleRequest(
                    "com.example.generated", className, List.of()), className);
        }
    }
    ...
    void rejectsBlankBindingAndDependencyNames() {
        for (String name : List.of("", " ", "\t\n")) {
            assertThrows(IllegalArgumentException.class, () -> namedBinding("com.example.Service", name), name);
            assertThrows(IllegalArgumentException.class, () -> new GeneratedModuleRequest.ConstructorBinding(
                    "com.example.Service", Optional.of(name), List.of()), name);

            assertThrows(IllegalArgumentException.class, () -> named("com.example.Repository", name), name);
            assertThrows(IllegalArgumentException.class, () -> new GeneratedModuleRequest.Dependency(
                    "com.example.Repository", Optional.of(name)), name);
        }
    }
