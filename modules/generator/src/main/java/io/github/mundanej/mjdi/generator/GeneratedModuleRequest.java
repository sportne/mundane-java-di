...
public record GeneratedModuleRequest(
  ...
  private static final Set<String> JAVA_KEYWORDS_AND_LITERALS =
      Set.of(
          "_",
          "abstract",
          "assert",
   ...
   */
  public record ConstructorBinding(
      String typeName, Optional<String> name, List<Dependency> dependencies) {
    /**
     ...
     * @return a binding request
     */
    public static ConstructorBinding namedBinding(
        String typeName, String name, Dependency... dependencies) {
