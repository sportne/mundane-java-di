...
public final class Providers {
     ...
     * The wrapper is thread-safe for normal acyclic providers. The wrapped provider's own code
     * still needs to be safe for the way the application uses it. When this wrapper is used through
     * an {@link AppContext}, {@code null} values are rejected by the context.
     *
